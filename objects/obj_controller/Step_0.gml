...
var gameplay_can_advance = !card_gesture_active && !match_menu_active
    && !opening_match_menu && !toggling_auto;
if (gameplay_can_advance) {
    vv_tutorial_update();
    // Tutorial reading pauses rules, not the feedback being explained.
