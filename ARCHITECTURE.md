...
- `scripts/vv_ai/vv_ai.gml`: snapshot-based Enemy target scoring, deterministic ranking, and Build-slot selection; it never resolves attacks or mutates match state.
